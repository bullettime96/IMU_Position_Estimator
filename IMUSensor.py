...
class IMUSensor:
    ...
    def plotRawMeasurements(self, show=False, file='rawMeasurements.jpg'):
        ...
        plt.plot(self.getTimestamps()/1000, self.getRawAcceleratorX())
        # plt.show()
        plt.subplot(1, 3, 2)
        # plt.figure()
        plt.xlabel('Time [s]')
        ...
        plt.plot(self.getTimestamps()/1000, self.getRawAcceleratorY())
        # plt.show()
        plt.subplot(1, 3, 3)
        # plt.figure()
        plt.xlabel('Time [s]')
        ...
        plt.plot(self.getTimestamps()/1000, self.getRawAcceleratorZ())
        plt.show()
        # plt.figure()
        plt.subplot(3, 2, 2)
        # plt.title('Total Acceleration')
        # plt.plot(self.getTimestamps()/1000, self.getTotalAcceleration())
        # plt.subplot(4, 2, 2)
        plt.title('Rotation rate around X Axis')
        plt.xlabel('Time [s]')
        plt.ylabel('Rotation rate [deg.s^-1]')
        plt.plot(self.getTimestamps()/1000, self.getGyroX())
        # plt.show()
        plt.subplot(3, 2, 4)
        # plt.figure()
        plt.xlabel('Time [s]')
